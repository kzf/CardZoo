Spells = [
 {
   ...
   description: 'Send a character to <span data-tooltip="Creatures cannot attack while asleep.">sleep</span> for one turn.',
   cast: function (card) {
   	card.attackDelay = 2;
      card.asleep = true;
   },
 ...
 },
 {
   ...
   castable: function (players, id) {
      return players[id].board.length < Config.maxMinionsOnBoard;
   },
   targeted: false
 },
 {
